...
class Supervisor(Node):
    ...
    def __init__(self):
        ...
        self.AlignmentStatusServer = self.create_service(ActivateNode, 'alignment_finish', self.alignment_status_callback)
    ...
    # ############# THERMAL TARGET Server Response: Handle Transition to ALignment State ############# #
    def thermal_target_callback(self, request, response):
        ...
        if thermal_target_detected:
            ...
            self.toggle_alignment(thermal_target_detected)
        else:
